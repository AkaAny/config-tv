...
func NewBaseK8sPluginFromConfig(pluginConfigMap config_tv.PluginConfig) *BaseK8sPlugin {
	var pluginConfig = config_tv.ConvertPluginConfig[BaseK8sPluginConfig](pluginConfigMap)
